...
### 🎯 Conventions trong ASP.NET Core

Để hiểu sâu hơn về các quy tắc mặc định (conventions) trong ASP.NET Core:

**[📖 CHƯƠNG 03: ASP.NET Core Conventions →](./03_aspnet_core_conventions.md)**
