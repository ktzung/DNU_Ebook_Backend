...
### 🎯 Layout, Partial Views & Tái sử dụng

Để hiểu sâu hơn về cách phân chia, kế thừa và tái sử dụng bố cục:

**[📖 CHƯƠNG 08: Layout, Partial Views & Tái sử dụng bố cục →](./08_layout_partial_views_reuse.md)**

**Nội dung:**
- ✅ Layout mặc định và tùy chỉnh
- ✅ _ViewStart.cshtml và _ViewImports.cshtml
- ✅ Partial Views (tái sử dụng HTML)
- ✅ Sections (inject content)
- ✅ View Components (nâng cao)
- ✅ Kế thừa Layout (Nested Layouts)
